...
public class Custom_request_adapter extends ArrayAdapter<ServiceRequest> {
    private Activity context;
    private List<ServiceRequest> customRequestList;

    public Custom_request_adapter(Activity context, List<ServiceRequest> customRequestList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (request.getorderType().equals("Custom")) {
